...
public interface BookServiceClient {
    ...
    ResponseEntity<BookIdDto> getBookByIsbn(@PathVariable(value = "isbn") String isbn); //bu value vermek zorundasın feingclient algılaması için

    //burdaki exception feing den geliyor
